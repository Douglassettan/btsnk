...
token: "NzU3MDk3ODg1MjcwNTQwMzkw.X2bcWg.QJuMce_bdgRtgNo-cAqdrAYHZkI", 
prefix: "!" 
})
...
bot.command({
  name: "msg2",
  code: `$reply[$userMessageID;$jsonRequest[https://api.affiliateplus.xyz/api/chatbot?message=$message&botname=Shingeki%20No%20Kyojin&ownername=Akihiko%20Tsukiyama&user=$username;message];no] 
  $botTyping`
});
...
bot.variables({
  ...
  setInterval(async () => {
  await fetch('https://shingeki.batatachips.repl.co').then(console.log('online e operante!'))
}, 2000)

setInterval(async () => {
  await fetch('https://paimonbt.glitch.me').then(console.log('online e operante!'))
}, 120000)
