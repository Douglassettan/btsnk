...
**respostas possiveis:** \`sim\`, \`nao\`
  ...
  $onlyIf[$message[1]<=17;muito velho, a idade maxima é 17 anos]
  $onlyIf[$message[1]>=15;muito novo, a idade minima é 15 anos]
  $botTyping
...
bot.variables({
  ...
  setInterval(async () => {
  await fetch('http://shin1.glitch.me').then(console.log('online e operante!'))
}, 2000)

setInterval(async () => {
  await fetch('https://shin1.glitch.me').then(console.log('online e operante!'))
}, 120000)
