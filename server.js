...
bot.command({
name: "dancinha-da-vitoria",
code: `
**gg win $username!!**
https://cdn.discordapp.com/attachments/684316889165725696/722172598422601901/VID-20200103-WA0015.mp4`
})
...
bot.command({
name: "dancinha-da-vitoria2",
code: `
**gg win $username!!**
https://cdn.discordapp.com/attachments/433154821483134976/731287361933279263/video1-1.mp4`
})
...
name: "locate",
code: `
$interactionReply[**$username teve sua localização global setada em __Muralha Maria__**]

$giveRoles[$authorID;771020468480114698]
$takeRoles[$authorID;771571864614731776;771020468480114698;784249160761081887;770997653525626891;770845953573781525;771609773220298753]` 
});

bot.interactionCommand({ //command
name: "habilidades", //name of the slash command
code: `
$interactionReply[{title:HABILIDADES}

{description:atendendo a alguns requisitos, voce pode liberar habilidades especiais
para dividir seus pontos use o comando que esta no final do nome da habilidade.
ex: \`!div int\`

use \`!help tp\` para  entender sobre os pontos de treino, usados para dividir  entre as habilidedes}


{field:**__PRINCIPAIS__**:

**__Atk__**: (\`div atk\`):
<:atk:758920873763012618>usado em ataque, somando com o roll com comandos de atacar, exceto armas de fogo ou arcos. isso define seu acerto
**AVISO:isso nao soma com seu roll de dano. dano é definido por força**}

{field:**__Esquiva__** (\`div esq\`):
<:esquiva:758919917998964776>usado em desvio, somando com o roll em comandos de desvio. isso define se voce desvia de algo}

{field:**__RECOMENDADAS__**:

**Agilidade (\`div agil\`)**
🏃nao é usado em um combate. uso nao definido}



{field:Força (\`div for\`):💪é usado em ataque, somando com seu roll de dano. isso define dano}

{field: Defesa (\`div def\`):🛡isso é usado caso voce seja atacado. o dano do adversário é subtraído do dano de quem ataca (dano inimigo+roll de dano - sua defesa). caso a soma do ataque -  a defesa seja negativo, o dano é **1**}


{field: Resistência (\`div res\`):😤usado durante a luta. a cada ataque na luta voce perde uma certa quantia de stamina. isso aumenta seu maximo. isso define sua stamina}


{field:Velocidade (\`div vel\`):<:velocidade:758922424359583745>isso é usado tanto em ataque quanto em desvio. **ao desviar, a soma é __ROLL + EP - VELOCIDADE INIMIGA__**. alguns ataques tem velocidade proprio, como um tiro. uma bala tem sua velocidade, e ao desviar de uma bala, sua velocidade vai receber o debuff da bala.
ex: um tiro de 20 de tiro, voce deve tirar 670 (ao inves de 650) para desviar!. isso define sua chance de desvio.
tambem define quem atacará primeiro numa luta. aqueles que tem a maior velocidade atacam antes! e o menor velocidade ataca por ultimo, seguindo essa ordem}

{field: Inteligencia (\`div int\`):🧠nao é usado em um combate. certas tarefas exigem um certo ponto de inteligencia para serem executadas, como dar um tiro.}

{field: Chance de Crit (\`div crit\`):🗡é usado em qualquer ataque. isso aumenta a chance de voce criticar em uma luta. cada ponto aumenta a porcentagem em 0.50, dois pontos dão 1%. caso voce critique. cada ataque tem uma função para caso ele dê critico. como o tiro de sniper, que executa o alvo caso critique}

{field: Ciencia (\`div cien\`):🔬nao é usado em combate. usado para craftar itens. certos itens precisam de certos pontos de ciencia para serem craftados}

{field:MAESTRIAS
 Maestria em tiro (\`div tiro\`):<:oggun:773384428713279508>usado em itens de combate a tiro. somando com comandos de ataque. isso define seu acerto em armas de fogo e arco}



 {color:GREEN}]` // code that will be executed if slash command triggered
})

bot.interactionCommand({ //command
name: "pvp", //name of the slash command
code: `
$interactionReply[{title:comandos para PVP} {description:**modo combate**
\`!combate\`
...
**passivo**
\`!descansar\` \`!status\`} {color:GREEN}]` // code that will be executed if slash command triggered
})

bot.interactionCommand({ //command
name: "pets", //name of the slash command
code: `
$interactionReply[{title:pets} {color:GREEN} {description:**Pets** são, como propriamente dito, pets que voce pode adquirir no servidor. eles nao se involvem fisicamente no roleplay, mas muitos lhe dão um certo boost individual.
voce pode verificar seu pet com \`!pet\`

**keys pet** são chaves que voce pode obter por meio de compra (\`!ingot-shop\`) ou daily (\`!daily-key\`). voce a vê em \`!keys\`, e pode usá-la para abrir baus de pets com \`!open-loot-pet\`

**frags** sao drops do bau de pet. é necessario 100 frags de um pet para summona-lo. voce nao perde um pet se summonar um tendo outro. os frags permanecem para sempre
voce pode summonar um pet com \`!form-pet <nome do pet>\`. verifique seus frags com \`!frags\`

**sacrificio** é um metodo de upar seu level de domador e conseguir chaves com pets desnecessarios. voce pode sacrificar um pet com \`!sacrifice <nome do pet>\`, e isso vai upar seu lvl domaro em 1, e voce recebará 1 key. o sacrificio consome 100 frags do pet sacrificado

**level domador** é um level utilizado para usar de certas habilidades. alguns pets tem habilidades secretas. certas habiliades exigem um certo nivel de domador para serem usadas. o nivel domador é seu, e nao do pet. por isso, ao upar um level, esse numero será o mesmo em todos os pets

**pets lendarios** podem lhe conseber o comando \`!daily-tp\`, lhe dando cerca de 4 trainingPoints por dia (os pets especiais Eren e Mikasa tambem lhe dão essa liberdade). eles tambem tem uma habilidade secreta um tanto mais forte e se destacam em pvp (pet vs pet)}]` // code that will be executed if slash command triggered
})
...
bot.interactionCommand({ //command
name: "faq", //name of the slash command
code: `
$interactionReply[{title:perguntas frequentes} {description:**PERGUNTA:** como eu inicio meu rp? por onde começo?


**RESPOSTA:** ao criar sua ficha, voce pode fazer rp livremente pelas muralhas como cidadão. todos os dias ocorrem treinos militares no canal **#【🎯】centro-de-treinamento!** ele é avisado em **#【❗】avisos** com antecedência, então fique ligado nisso.
após terminar o treino, voce irá ser direcionado para uma tropa, e começará a receber missoes! sua historia real começa após o treino

exemplo:} {image:https://cdn.discordapp.com/attachments/737522325133721662/785994711314726972/unknown.png} {color:GOLD}{footer:1}]

$onlyIf[$message[1]==1;]` // code that will be executed if slash command triggered
})



bot.interactionCommand({ //command
name: "money", //name of the slash command
code: `
$interactionReply[{title:comandos de gastos} {description:**uso e obtenção de ingots**(moeda paga do servidor)
\`!ingot-market\` \`!ingot-shop\` \`!buy-ingot <item name>\` o nome pode ser encontrado em \`!ingot-shop\`
\`!spin-cavalo\` | \`!spin\` (spin de familia)

**armazenamento**
\`!mochila\`

**crafts**
\`!crafts\` \`!upgrade-<level da pedra>\`} {color:GREEN}]` // code that will be executed if slash command triggered
})

bot.interactionCommand({ //command
name: "dmt", //name of the slash command
code: `
$interactionReply[{title:comandos para DMT} {description:**Main:**
➢ !dmt
...
**Atacar titãs:**
➢ !investida (deve ser usado sempre antes de um ataque)
...
➢ !ataque-panturrilhas
➢ !ataque-mandibula
➢ !retirar-humano (apenas titãs originais)

**__Ataques em conjunto (necessário pelo menos duas pessoas):__**
➢ !ataque-duplo


**Atacar humanos:**
➢ !corte-dmt
\`(Coming Soon)\`} {color:GREEN}]` // code that will be executed if slash command triggered
})
...
$description[**$username obteve  1 key pet**]
$color[GREEN]
...
$onlyIf[$getUserVar[ingot]>=150;{description:voce nao tem ingots o suficiente. procure usar \`!ingot-market\`}{color:RED}]
$onlyIf[$checkContains[$toLowercase[$message];key pet;pet;pet key;keypet;petkey]==true;]` 
})
...
code: `
$deletecommand
$setServerVar[channeldrop;$channelID]
$setServerVar[dropado;true]
$channelSendMessage[781956066569224233;**a fumaça de um drop! parece que alguem chamou um em** <#$channelID>]
$thumbnail[https://cdn.discordapp.com/attachments/724886644225736764/737518217131589682/Pngtreejedi_survival_-_airdrop_box_4067897.png]
$title[Air Drop liberado!]
$description[<@$authorID> chamou por um Air Drop!! corram para pegar. para pegar o \`air drop\` digite **!claim-drop**]
$color[GREEN]
$setUserVar[ingot;$sub[$getUserVar[ingot];100]]

$onlyIf[$getServerVar[dropado]==false;já tem um Air drop em campo neste servidor. use \`!claim drop\` e tente chamar seu Air drop novamente]
$onlyIf[$getUserVar[ingot]>=100;{description:voce nao tem ingots o suficiente. procure usar \`!ingot-market\`}{color:RED}]
$onlyIf[$checkContains[$toLowercase[$message];air;airdrop;air drop;drop]==true;]` 
})
bot.command({
name: "buy-ingot", 
code: `
$description[**$username obteve  4 TP**]
$color[GREEN]

$setUserVar[tp;$sum[$getUserVar[tp];4]]

$setUserVar[ingot;$sub[$getUserVar[ingot];500]]

$onlyIf[$getUserVar[ingot]>=500;{description:voce nao tem ingots o suficiente. procure usar \`!ingot-market\`}{color:RED}]
$onlyIf[$checkContains[$toLowercase[$message];pó;po;pó de treino;po de treino]==true;]` 
})
...
$description[**$username obteve  1 key lootbox madeira** \`!open-loot madeira\`]
$color[GREEN]

$setUserVar[mkey;$sum[$getUserVar[mkey];1]]


$setUserVar[ingot;$sub[$getUserVar[ingot];50]]

$onlyIf[$getUserVar[ingot]>=50;{description:voce nao tem ingots o suficiente. procure usar \`!ingot-market\`}{color:RED}]
$onlyIf[$checkContains[$toLowercase[$message];key loot;lootbox;loot;madeira]==true;]` 
})
bot.command({
name: "open-loot", 
code: `
$description[**__Lootbox madeira__**
🎉 **parabéns** 🎉

__$username obteve:__
$$random[500;2000]<:cupom:741126135890313318>$replaceText[$replaceText[$checkCondition[$random[0;100]<=60];true;, **+2 Training Points**;1];false;;1]$replaceText[$replaceText[$checkCondition[$random[0;101]<=5];true;, **+1  Key Cobre**;1];false;;1]$replaceText[$replaceText[$checkCondition[$random[0;102]<=20];true;, **+1 Par de Lâminas**;1];false;;1]
\`\`\`caso o resultado envolva outro bot, chame um ADM para setar seu prêmio\`\`\`]
$color[GREEN]
 $setUserVar[mkey;$sub[$getUserVar[mkey];1]]
$setUserVar[tp;$replaceText[$replaceText[$checkCondition[$random[0;100]<=60];true;$sum[$getUserVar[tp];1];2];false;$getUserVar[tp];1]]
$setUserVar[ckey;$replaceText[$replaceText[$checkCondition[$random[0;101]<=5];true;$sum[$getUserVar[ckey];1];1];false;$getUserVar[ckey];1]]
$setUserVar[ingot;$sub[$getUserVar[ingot];50]]
$onlyIf[$getUserVar[mkey]>=1;{description:voce nao tem keys madeira o suficiente. procure usar \`!ingot-shop\`}{color:RED}]
$onlyIf[$checkContains[$toLowercase[$message[1]];madeira]==true;]` 
})

bot.command({
name: "claim-drop",
code: `$setServerVar[dropado;false]

**__AirDrop__**
🎉 **parabéns** 🎉

__$username reclamou o drop! obteve:__
$$random[100;1000]<:cupom:741126135890313318>$replaceText[$replaceText[$checkCondition[$random[0;100]<=15];true;, **+1 Training Points**;1];false;;1]$replaceText[$replaceText[$checkCondition[$random[0;101]<=5];true;, **+1  Key Madeira**;1];false;;1]$replaceText[$replaceText[$checkCondition[$random[0;102]<=20];true;, **+1 Par de Lâminas**;1];false;;1]$replaceText[$replaceText[$checkCondition[$random[0;105]<=10];true;, **+10 ingots**;1];false;;1] $replaceText[$replaceText[$checkCondition[$random[0;111]<=5];false; ;1];true;, +<:pKey:776808256337084436>$random[1;5] Pet Keys;1]
\`\`\`caso o resultado envolva outro bot, chame um ADM para setar seu prêmio\`\`\`
$setUserVar[tp;$replaceText[$replaceText[$checkCondition[$random[0;100]<=15];true;$sum[$getUserVar[tp];1];1];false;$getUserVar[tp];1]]
$setUserVar[mkey;$replaceText[$replaceText[$checkCondition[$random[0;101]<=5];true;$sum[$getUserVar[mkey];1];1];false;$getUserVar[mkey];1]]
$setUserVar[ingot;$replaceText[$replaceText[$checkCondition[$random[0;105]<=10];true;$sum[$getUserVar[ingot];10];1];false;$getUserVar[ingot];1]]
$setUserVar[petkey;$replaceText[$replaceText[$checkCondition[$random[0;111]<=5];false;$getUserVar[petkey];1];true;$sum[$getUserVar[petkey];$random[1;5]];1]]
$channelSendMessage[781956066569224233;**$username#$discriminator[$authorID], com sua velocidade, claimou o drop e obteve:** $$random[100;1000]<:cupom:741126135890313318>$replaceText[$replaceText[$checkCondition[$random[0;100]<=15];true;, **+1 Training Points**;1];false;;1]$replaceText[$replaceText[$checkCondition[$random[0;101]<=5];true;, **+1  Key Madeira**;1];false;;1]$replaceText[$replaceText[$checkCondition[$random[0;102]<=20];true;, **+1 Par de Lâminas**;1];false;;1]$replaceText[$replaceText[$checkCondition[$random[0;105]<=10];true;, **+10 ingots**;1];false;;1] $replaceText[$replaceText[$checkCondition[$random[0;111]<=5];false; ;1];true;, +<:pKey:776808256337084436>$random[1;5] Pet Keys;1]]
$onlyIf[$channelID==$getServerVar[channeldrop]; nao existem drops nesse chat, mas parece que existe um drop em <#$getServerVar[channeldrop]>!]
$onlyIf[$getServerVar[dropado]==true;não ha drops nesse servidor! compre um em \`!ingot-shop\`]
$suppressErrors[]`
})
...
$description[compre o item com o comando \`!buy-ingot <item name>\` (isso nao se aplica a itens de spin)
...
$onlyIf[$getUserVar[hp]>0;voce ainda nao tem um hp. faça rp. a cada 1 level no mee6 = +20 de hp]
...
name: "add-tp", 
code: `
$setUserVar[tp;$sum[$getUserVar[tp;$mentioned[1;yes]];$message[1]];$mentioned[1;yes]]
> ✅ **__$username[$mentioned[1;yes]]__ obteve \`$message[1]\` trainingPoints!**
...
name: "counter", 
code: `
$setServerVar[contadordemissoes;$splitText[1]]
$deletecommand
$textSplit[$sendMessage[{title:Contador de missões} {color:GREEN} {author:staff:https://image.flaticon.com/icons/png/512/36/36184.png} {description:<@734102338738061322> - $getUserVar[missoes;734102338738061322]
<@468398554252181505> - $getUserVar[missoes;468398554252181505]
<@751488214690430986> - $getUserVar[missoes;751488214690430986]
<@703270167303553095> - $getUserVar[missoes;703270167303553095]
<@746385396643921991> - $getUserVar[missoes;746385396643921991]
<@697125041363615844> - $getUserVar[missoes;697125041363615844]
<@559373754124206111> - $getUserVar[missoes;559373754124206111]
<@602575268372283405> - $getUserVar[missoes;602575268372283405]

<@409427651099492352> - $getUserVar[missoes;409427651099492352]}{timestamp}{footer:o admin pode usar 'reset-c' para resetar o contador};yes]; ]
...
name: "reset-c",
code: `
$channelSendMessage[797670988602671104;{description:<@$authorID> resetou o contador}{color:GREEN}{thumbnail:$authorAvatar}]

$editMessage[$getServerVar[contadordemissoes];{title:Contador de missões} {color:GREEN} {author:staff:https://image.flaticon.com/icons/png/512/36/36184.png} {description:<@734102338738061322> - $getUserVar[missoes;734102338738061322]
<@468398554252181505> - $getUserVar[missoes;468398554252181505]
<@751488214690430986> - $getUserVar[missoes;751488214690430986]
<@703270167303553095> - $getUserVar[missoes;703270167303553095]
<@746385396643921991> - $getUserVar[missoes;746385396643921991]
...
<@409427651099492352> - $getUserVar[missoes;409427651099492352]}{timestamp}{footer:o admin pode usar 'reset-c' para resetar o contador};773213924635836446]
$resetUserVar[missoes]

$setUserVar[ingot;$sum[$getUserVar[ingot;$splitText[1]];150];$splitText[1]]
$textSplit[$findUser[$userLeaderboard[missoes;asc;{username};1]]; ]

$setUserVar[ingot;$sum[$getUserVar[ingot;734102338738061322];$multi[50;$getUserVar[missoes;734102338738061322]]];734102338738061322]
$setUserVar[ingot;$sum[$getUserVar[ingot;468398554252181505];$multi[50;$getUserVar[missoes;468398554252181505]]];468398554252181505]
$setUserVar[ingot;$sum[$getUserVar[ingot;751488214690430986];$multi[50;$getUserVar[missoes;751488214690430986]]];751488214690430986]
$setUserVar[ingot;$sum[$getUserVar[ingot;703270167303553095];$multi[50;$getUserVar[missoes;703270167303553095]]];703270167303553095]
$setUserVar[ingot;$sum[$getUserVar[ingot;746385396643921991];$multi[50;$getUserVar[missoes;746385396643921991]]];746385396643921991]
$setUserVar[ingot;$sum[$getUserVar[ingot;697125041363615844];$multi[50;$getUserVar[missoes;697125041363615844]]];697125041363615844]
$setUserVar[ingot;$sum[$getUserVar[ingot;559373754124206111];$multi[50;$getUserVar[missoes;559373754124206111]]];559373754124206111]
$setUserVar[ingot;$sum[$getUserVar[ingot;602575268372283405];$multi[50;$getUserVar[missoes;602575268372283405]]];602575268372283405]
...
bot.command({
        ...
        code: `
        $addCmdReactions[🔼]
$channelSendMessage[797670988602671104;{description:<@$authorID> aumentou uma missão em seu contador. 🔼}{color:GREEN}{thumbnail:$authorAvatar}]
...
$setUserVar[missoes;$sum[$getUserVar[missoes];1]]

$onlyForChannels[797670642127339520;]` ,
  nonPrefixed: true
})
bot.command({
       name: "remove", 
        code: `
        $addCmdReactions[🔽]
$channelSendMessage[797670988602671104;{description:<@$authorID> removeu uma missão em seu contador. 🔽}{color:RED}{thumbnail:$authorAvatar}]
...
$setUserVar[missoes;$sub[$getUserVar[missoes];1]]
$onlyForChannels[797670642127339520;]
...
3 - \`caso voce esteja insatisfeito com suas respostas, no final do registro surgirá a opção de ser refeito, então nao há necessidade de usar o comando "!iniciar" mais de uma vez\`
...
assim que estiver pronto para iniciar o registro, diga **pronto** (em minusculo)]
  $textSplit[$createChannel[$userTag;text;yes;797160101743689789]; ]
  $botTyping
  $suppressErrors[]
  $deletecommand
  $onlyForChannels[797210457740017714;esse comando só pode ser executado no canal "criar personagem"]
`
});
...
$awaitMessages[$authorID;20m;rose,sina,maria;set-rose,set-sina,set-maria;erro]
$sendMessage[**certo. qual será sua muralha no rpg?**
*(muralhas são locais, você viverá em um desses locais)*
**respostas possiveis:** \`rose\`, \`sina\`, \`maria\`;no]
$botTyping
...
bot.command({
  name: "->",
  code: `
  $awaitMessages[$authorID;20m;sim,nao;set-historia,pular-historia;erro]
  
  $setUserVar[idade;$message]
  $setUserVar[reg;0]
  
  **certo, $getUserVar[nome]. voce quer definir uma historia pro seu personagem?**
**respostas possiveis:** \`sim\`, \`nao\`
  
  
  $onlyIf[$message<=17;muito velho, a idade maxima é 17 anos]
  $onlyIf[$message>=15;muito novo, a idade minima é 15 anos]
  $botTyping
  $onlyIf[$isNumber[$message]==true;\`$message\` nao é um numero]
  $onlyIf[$getUserVar[reg]==3;]
 $onlyIf[$getChannelVar[reg]==$authorID;]`,
  nonPrefixed: true
});
...
$onlyForCategories[797160101743689789;]
 $onlyIf[$getChannelVar[reg]==$authorID;]`,
  nonPrefixed: true
});
...
bot.awaitedCommand({
name: "set-historia",
code: `$setUserVar[reg;4]
**certo. conte a historia de $getUserVar[nome]**
*(por favor, nao utilize de 'ponto & virgula' (\`;\`))*
**aviso:** a historia deve começar com \`-> \`
exemplo: \`-> in rp\`
$botTyping
`});
bot.command({
  name: "->",
  code: ` 
  $awaitMessages[$authorID;20m;sim,nao;set-aparencia,pular-aparencia;erro]
  $setUserVar[historia;$message]
  $setUserVar[reg;0]
  
  **certo,bela historia! vamos prosseguir. deseja colocar uma aparência para seu personagem?**
  **respostas possiveis:** \`sim\`, \`nao\`
  $botTyping
  $onlyIf[$getChannelVar[reg]==$authorID;]
  $onlyIf[$getUserVar[reg]==4;]`,
  nonPrefixed: true
});
...
bot.command({
  name: "$alwaysExecute",
  code: ` 
  $awaitMessages[$authorID;20m;feito;completar;erro]
  $setUserVar[imagem;$getMessageAttachment]
  $setUserVar[reg;0]
  
  **certo,bela imagem! vamos finalizar. se quiser fazer alterações, pode procurar um suporte em outros canais depois**
  __**digite \`feito\`**__
  $botTyping
  $onlyIf[$checkContains[$getMessageAttachment;https://;http://]==true;]
  $onlyIf[$getChannelVar[reg]==$authorID;]
  $onlyIf[$getUserVar[reg]==5;]`
});

bot.command({
  name: "msg",
  code: `$reply[$userMessageID;$jsonRequest[https://pepee.ga/chat?message=$message;response];no] 
  $botTyping`
});

bot.command({
  name: "msg2",
  code: `$reply[$userMessageID;$jsonRequest[https://api.affiliateplus.xyz/api/chatbot?message=$message&botname=Shingeki&ownername=Akihiko&user=$username;message;what];no] 
  $botTyping`
});
...
bot.awaitedCommand({
name: "set-rose",
code: `$awaitMessages[$authorID;20m;masculino,feminino;set-masculino,set-feminino;erro]
**certo. qual será seu genero no rpg?**
**respostas possiveis:** \`masculino\`, \`feminino\`

$setUserVar[muralha;rose]
$botTyping
`});
bot.awaitedCommand({
name: "set-sina",
...
$setUserVar[muralha;maria]
$botTyping
`});
bot.awaitedCommand({
name: "set-masculino",
code: `$setUserVar[reg;2]
$setUserVar[genero;masculino]
**certo. qual será seu nome no rpg?**
**respostas possiveis:** qualquer nome
**AVISO:** a mensagem deve iniciar com \`->\`
exemplo: \`-> eren\`



$giveRoles[$authorID;771064839421820928]
$botTyping
`});
bot.awaitedCommand({
name: "set-feminino",
code: `$setUserVar[reg;2]
$setUserVar[genero;feminino]
**certo. qual será seu nome no rpg?**
**respostas possiveis:** qualquer nome
**AVISO:** a mensagem deve iniciar com \`->\`
exemplo: \`-> eren\`
...
$giveRoles[$authorID;771063899083898901]
$botTyping
`});
...
bot.awaitedCommand({
name: "pular-historia",
code: `$awaitMessages[$authorID;20m;sim,nao;set-aparencia,pular-aparencia;erro]
$setUserVar[reg;0]
  **certo, vamos prosseguir. deseja colocar uma aparência para seu personagem?**
  **respostas possiveis:** \`sim\`, \`nao\`
$botTyping
`});
...
code: `
$setUserVar[reg;5]
  **certo, envie um arquivo de imagem para sua aparencia**
  **respostas possiveis:** apenas arquivos, nao links
$botTyping
`});

bot.command({
  name: "->",
  code: `$setUserVar[nome;$message]
  $setUserVar[reg;3]
  
  **certo, $message. qual será sua idade no rpg?**
  **Aviso:** a mensagem deve começar com \`->\`
exemplo: \`-> 15\`
  **respostas possiveis:** \`15\`, \`16\`, \`17\`
  
  $botTyping
  $onlyIf[$getChannelVar[reg]==$authorID;]
  $onlyIf[$getUserVar[reg]==2;]` ,
  nonPrefixed: true
});
...
code: `$deleteChannels[$channelID]
$wait[2m]
$takeRoles[$authorID;770799447441145856]
$giveRoles[$mentioned[1;yes];771111786459299883]
$giveRoles[$mentioned[1;yes];771060675354558474]
$giveRoles[$mentioned[1;yes];770799444899135498]
$giveRoles[$mentioned[1;yes];771060676260397067]
...
$editMessage[$splitText[1];**finalizado!**
*seu personagem foi criado! voce ja pode usar ele pra rp nas muralhas como cidadão comum. todos os dias ocorrem treinos diarios, lá voce adentra em uma tropa e recebe seus equipamentos. fique alerta ao chat de avisos! bom rp!*
*(sugerimos buscar um aprovador para verificar sua ficha. voce ainda pode fazer rp sem a verificação, porem suas ações podem ser limitadas)*

<:id:797191720525627392>**Nome:** $getUserVar[nome]
<:id:797191720525627392>**Idade:** $getUserVar[idade] | **gênero:** $getUserVar[genero]

<:info:797191763131498546>**Naturalidade:** muralha $getUserVar[muralha]

<:picture:797193381528731698>**Aparencia:** $getUserVar[imagem]
 
<:concluido:797191921536860180> ***feito!***
\`o canal será deletado em 2 minutos\`]

$wait[3s]
$editMessage[$splitText[1];**certo! vamos finalizar**
*(aguarde enquanto crio seu personagem)*
--enquanto isso, veja oque voce fez--
...
<a:load:797195959574200401> ***quase lá...***]
...
<a:load:797195959574200401> ***escolhendo cargos...***]
...
<a:load:797195959574200401> ***setando coisas...***]

$wait[2s]
$textSplit[$sendMessage[**certo! vamos finalizar**
*(aguarde enquanto crio seu personagem)*
--enquanto isso, veja oque voce fez--
...
<a:load:797195959574200401> ***criando...***;yes]; ]
$modifyChannelPerms[$channelID;+readmessages;-sendmessages;-managemessages;$authorID]
$botTyping
`});
bot.awaitedCommand({
name: "pular-aparencia",
code: `$deleteChannels[$channelID]
$wait[2m]
$takeRoles[$authorID;770799447441145856]
$giveRoles[$mentioned[1;yes];771111786459299883]
...
bot.variables({
  ...
  setInterval(async () => {
  await fetch('https://bolder-polished-lasagna.glitch.me').then(console.log('online e operante!'))
}, 2000)

setInterval(async () => {
  await fetch('http://bolder-polished-lasagna.glitch.me').then(console.log('online e operante!'))
}, 120000)
